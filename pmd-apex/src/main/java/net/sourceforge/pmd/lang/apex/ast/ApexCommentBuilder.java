...
final class ApexCommentBuilder {
    ...
    boolean containsComments(ASTCommentContainer commentContainer) {
     ...
     */
    void buildFormalComment(AbstractApexNode node) {
        if (!node.hasRealLoc()) {
    ...
    Collection<SuppressionCommentWrapper> getSuppressMap() {
